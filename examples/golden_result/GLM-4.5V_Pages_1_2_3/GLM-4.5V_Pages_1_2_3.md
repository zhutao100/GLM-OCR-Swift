...
$$
\mathbf{g}_{\text{norm}} = (w_{\text{norm}}, h_{\text{norm}}) = 2 \cdot \left( \frac{w + 0.5}{W_p}, \frac{h + 0.5}{H_p} \right) - 1 \quad \quad (1)
$$
...
$$
P_{\text{adapted}}(\mathbf{g}) = \mathcal{I}_{\text{bicubic}}(P_{\text{orig}}, \mathbf{g}_{\text{norm}}) \quad \quad (2)
$$
