...
Write $ \nabla^{2} $ as shorthand for $ \frac{\partial^{2}}{\partial x^{2}}+\cdots+\frac{\partial^{2}}{\partial x^{2}} $ ; then
...
$$
\det J _ {x} = \sum_ {\pi \in S} \operatorname {s g n} (\pi) x ^ {\nu (\pi)}.
$$

Integrating both sides from 0 to 1 (and substituting y = 1-x) yields

$$
\begin{array}{l} \sum_ {\pi \in S _ {n}} \frac {\operatorname {s g n} (\pi)}{\nu (\pi) + 1} = \int_ {0} ^ {1} (x + n - 1) (x - 1) ^ {n - 1} d x \\ = \int_ {0} ^ {1} (- 1) ^ {n + 1} (n - y) y ^ {n - 1} d y \\ = (- 1) ^ {n + 1} \frac {n}{n + 1}, \\ \end{array}
$$
